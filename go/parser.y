...
// at 2014-02-07 22:01:06.19323326 +0100 CET
//
...
|	DDD Type
	{
		$$ = []ParameterDecl{$1, $2} //TODO 210
	}

ParameterList:
	ParameterDecl ParameterList1
	{
		$$ = []ParameterList{$1, $2} //TODO 211
	}

ParameterList1:
	/* EMPTY */
	{
		$$ = []ParameterList1(nil) //TODO 212
	}
|	ParameterList1 ',' ParameterDecl
	{
		$$ = append($1.([]ParameterList1), ",", $3) //TODO 213
	}

Parameters:
	'(' Parameters1 ')'
	{
		$$ = []Parameters{"(", $2, ")"} //TODO 214
	}
...
PrimaryFactor:
	...
	{
		$$ = []PrimaryFactor{$1, $2} //TODO 227
	}

PrimaryFactor1:
	/* EMPTY */
	{
		$$ = []PrimaryFactor1(nil) //TODO 228
	}
|	PrimaryFactor1 PrimaryFactor11 PrimaryTerm
	{
		$$ = append($1.([]PrimaryFactor1), $2, $3) //TODO 229
	}
...
PrimaryTerm:
	...
	{
		$$ = []PrimaryTerm{$1, $2} //TODO 234
	}

PrimaryTerm1:
	/* EMPTY */
	{
		$$ = []PrimaryTerm1(nil) //TODO 235
	}
|	PrimaryTerm1 PrimaryTerm11 UnaryExpr
	{
		$$ = append($1.([]PrimaryTerm1), $2, $3) //TODO 236
	}
...
RangeClause:
	...
	{
		$$ = []RangeClause{$1, "range", $3} //TODO 244
	}
...
|	'(' DclName TYPE_NAME ')'
	{
		$$ = []Receiver{"(", $2, $3, ")"} //TODO 249
	}
|	'(' DclName '*' TYPE_NAME ')'
	{
		$$ = []Receiver{"(", $2, "*", $4, ")"} //TODO 250
	}
...
TypeDecl11:
	/* EMPTY */
	{
		$$ = []TypeDecl11(nil) //TODO 338
	}
|	TypeDecl11 TypeSpec ';'
	{
		$$ = append($1.([]TypeDecl11), $2, ";") //TODO 339
	}

TypeList:
	Type TypeList1
	{
		$$ = []TypeList{$1, $2} //TODO 340
	}

TypeList1:
	/* EMPTY */
	{
		$$ = []TypeList1(nil) //TODO 341
	}
|	TypeList1 ',' Type
	{
		$$ = append($1.([]TypeList1), ",", $3) //TODO 342
	}
...
|	PACK_NAME '.' TYPE_NAME
	{
		$$ = []TypeName{$1, ".", $3} //TODO 352
	}

TypeSpec:
	DclName Type
	{
		$$ = []TypeSpec{$1, $2} //TODO 353
	}

TypeSwitchCase:
	CASE TypeList
	{
		$$ = []TypeSwitchCase{"case", $2} //TODO 354
	}
|	DEFAULT
	{
		$$ = "default" //TODO 355
...
TypeSwitchGuard:
	...
	{
		$$ = []TypeSwitchGuard{$1, $2, ".", "(", "type", ")"} //TODO 356
	}
...
|	DclName COLAS
	{
		$$ = []TypeSwitchGuard1{$1, $2} //TODO 358
	}

TypeSwitchStmt:
	SWITCH TypeSwitchGuard LBR TypeSwitchStmt1 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, $3, $4, "}"} //TODO 359
	}
|	SWITCH SimpleStmt ';' TypeSwitchGuard LBR TypeSwitchStmt2 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, ";", $4, $5, $6, "}"} //TODO 360
	}
...
VarDecl11:
	/* EMPTY */
	{
		$$ = []VarDecl11(nil) //TODO 377
	}
|	VarDecl11 VarSpec ';'
	{
		$$ = append($1.([]VarDecl11), $2, ";") //TODO 378
	}
