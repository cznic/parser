...
// at 2013-08-01 22:22:35.466072905 +0200 CEST.
//
...
RangeClause:
	...
	{
		$$ = []RangeClause{$1, "range", $3} //TODO 230
	}

RangeClause1:
	ExpressionList '='
	{
		$$ = []RangeClause1{$1, "="} //TODO 231
	}
|	IdentifierList COLAS
	{
		$$ = []RangeClause1{$1, $2} //TODO 232
	}
...
|	'(' Dclname '*' Dclname ')'
	{
		$$ = []Receiver{"(", $2, "*", $4, ")"} //TODO 235
	}
|	'(' Dclname Dclname ')'
	{
		$$ = []Receiver{"(", $2, $3, ")"} //TODO 236
	}
...
|	PACK_NAME '.' TYPE_NAME
	{
		$$ = []ReceiverType{$1, ".", $3} //TODO 238
	}
|	'(' '*' TYPE_NAME ')'
	{
		$$ = []ReceiverType{"(", "*", $3, ")"} //TODO 239
	}
|	'(' '*' PACK_NAME '.' TYPE_NAME ')'
	{
		$$ = []ReceiverType{"(", "*", $3, ".", $5, ")"} //TODO 240
	}
|	'(' TYPE_NAME ')'
	{
		$$ = []ReceiverType{"(", $2, ")"} //TODO 241
	}
|	'(' PACK_NAME '.' TYPE_NAME ')'
	{
		$$ = []ReceiverType{"(", $2, ".", $4, ")"} //TODO 242
	}
...
|	RecvStmt11 RecvExpr
	{
		$$ = []RecvStmt{$1, $2} //TODO 245
	}

RecvStmt11:
	ExpressionList '='
	{
		$$ = []RecvStmt11{$1, "="} //TODO 246
	}
|	IdentifierList COLAS
	{
		$$ = []RecvStmt11{$1, $2} //TODO 247
	}

ReturnStmt:
	RETURN ReturnStmt1
	{
		$$ = []ReturnStmt{"return", $2} //TODO 248
	}
...
SelectStmt:
	SELECT '{' SelectStmt1 '}'
	{
		$$ = []SelectStmt{"select", "{", $3, "}"} //TODO 251
	}

SelectStmt1:
	/* EMPTY */
	{
		$$ = []SelectStmt1(nil) //TODO 252
	}
|	SelectStmt1 CommClause
	{
		$$ = append($1.([]SelectStmt1), $2) //TODO 253
	}
...
SendStmt:
	...
	{
		$$ = []SendStmt{$1, $2, $3} //TODO 255
	}

ShortVarDecl:
	IdentifierList COLAS ExpressionList
	{
		$$ = []ShortVarDecl{$1, $2, $3} //TODO 256
	}

Signature:
	Parameters Signature1
	{
		$$ = []Signature{$1, $2} //TODO 257
	}
...
SliceType:
	'[' ']' ElementType
	{
		$$ = []SliceType{"[", "]", $3} //TODO 274
	}

SourceFile:
	PackageClause ';' SourceFile1 SourceFile2
	{
		$$ = []SourceFile{$1, ";", $3, $4} //TODO 275
	}

SourceFile1:
	/* EMPTY */
	{
		$$ = []SourceFile1(nil) //TODO 276
	}
|	SourceFile1 ImportDecl ';'
	{
		$$ = append($1.([]SourceFile1), $2, ";") //TODO 277
	}

SourceFile2:
	/* EMPTY */
	{
		$$ = []SourceFile2(nil) //TODO 278
	}
|	SourceFile2 TopLevelDecl ';'
	{
		$$ = append($1.([]SourceFile2), $2, ";") //TODO 279
	}

Start:
	SourceFile
	{
		_parserResult = $1 //TODO 280
	}
...
StatementList1:
	/* EMPTY */
	{
		$$ = []StatementList1(nil) //TODO 297
	}
|	StatementList1 StatementList11 ';'
	{
		$$ = append($1.([]StatementList1), $2, ";") //TODO 298
	}
...
StructType:
	STRUCT '{' StructType1 '}'
	{
		$$ = []StructType{"struct", "{", $3, "}"} //TODO 301
	}

StructType1:
	/* EMPTY */
	{
		$$ = []StructType1(nil) //TODO 302
	}
|	StructType1 FieldDecl ';'
	{
		$$ = append($1.([]StructType1), $2, ";") //TODO 303
	}
...
TypeAssertion:
	'.' '(' Type ')'
	{
		$$ = []TypeAssertion{".", "(", $3, ")"} //TODO 314
	}

TypeCaseClause:
	TypeSwitchCase ':' StatementList
	{
		$$ = []TypeCaseClause{$1, ":", $3} //TODO 315
	}

TypeDecl:
	TYPE TypeDecl1
	{
		$$ = []TypeDecl{"type", $2} //TODO 316
	}
...
|	'(' TypeDecl11 ')'
	{
		$$ = []TypeDecl1{"(", $2, ")"} //TODO 318
	}

TypeDecl11:
	/* EMPTY */
	{
		$$ = []TypeDecl11(nil) //TODO 319
	}
|	TypeDecl11 TypeSpec ';'
	{
		$$ = append($1.([]TypeDecl11), $2, ";") //TODO 320
	}

TypeList:
	Type TypeList1
	{
		$$ = []TypeList{$1, $2} //TODO 321
	}

TypeList1:
	/* EMPTY */
	{
		$$ = []TypeList1(nil) //TODO 322
	}
|	TypeList1 ',' Type
	{
		$$ = append($1.([]TypeList1), ",", $3) //TODO 323
	}
...
TypeSpec:
	Dclname Type
	{
		$$ = []TypeSpec{$1, $2} //TODO 332
	}

TypeSwitchCase:
	CASE TypeList
	{
		$$ = []TypeSwitchCase{"case", $2} //TODO 333
	}
|	DEFAULT
	{
		$$ = "default" //TODO 334
...
TypeSwitchGuard:
	PrimaryExpr '.' '(' TYPE ')'
	{
		$$ = []TypeSwitchGuard{$1, ".", "(", "type", ")"} //TODO 335
	}
|	Dclname COLAS PrimaryExpr '.' '(' TYPE ')'
	{
		$$ = []TypeSwitchGuard{$1, $2, $3, ".", "(", "type", ")"} //TODO 336
	}

TypeSwitchStmt:
	SWITCH TypeSwitchGuard '{' TypeSwitchStmt2 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, "{", $4, "}"} //TODO 337
	}
|	SWITCH SimpleStmt ';' TypeSwitchGuard '{' TypeSwitchStmt2 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, ";", $4, "{", $6, "}"} //TODO 338
	}

TypeSwitchStmt2:
	/* EMPTY */
	{
		$$ = []TypeSwitchStmt2(nil) //TODO 339
	}
|	TypeSwitchStmt2 TypeCaseClause
	{
		$$ = append($1.([]TypeSwitchStmt2), $2) //TODO 340
	}
...
|	'^' UnaryExpr
	{
		$$ = []UnaryExpr{"^", $2} //TODO 345
	}
|	'*' UnaryExpr
	{
		$$ = []UnaryExpr{"*", $2} //TODO 346
	}
|	'&' UnaryExpr
	{
		$$ = []UnaryExpr{"&", $2} //TODO 347
	}
|	COMM UnaryExpr
	{
		$$ = []UnaryExpr{$1, $2} //TODO 348
	}
...
VarDecl11:
	/* EMPTY */
	{
		$$ = []VarDecl11(nil) //TODO 354
	}
|	VarDecl11 VarSpec ';'
	{
		$$ = append($1.([]VarDecl11), $2, ";") //TODO 355
	}

VarSpec:
	IdentifierList VarSpec1
	{
		$$ = []VarSpec{$1, $2} //TODO 356
	}

VarSpec1:
	Type VarSpec11
	{
		$$ = []VarSpec1{$1, $2} //TODO 357
	}
|	'=' ExpressionList
	{
		$$ = []VarSpec1{"=", $2} //TODO 358
