...
// at 2014-02-07 21:58:59.247110888 +0100 CET
//
...
Expression:
	Term Expression1
	{
		$$ = []Expression{$1, $2} //TODO 104
	}

Expression1:
	/* EMPTY */
	{
		$$ = []Expression1(nil) //TODO 105
	}
|	Expression1 OROR Term
	{
		$$ = append($1.([]Expression1), $2, $3) //TODO 106
	}
...
Factor1:
	/* EMPTY */
	{
		$$ = []Factor1(nil) //TODO 112
	}
|	Factor1 Factor11 PrimaryFactor
	{
		$$ = append($1.([]Factor1), $2, $3) //TODO 113
	}
...
FallthroughStmt:
	FALLTHROUGH
	{
		$$ = "fallthrough" //TODO 120
	}

FieldDecl:
	FieldDecl1 FieldDecl2
	{
		$$ = []FieldDecl{$1, $2} //TODO 121
	}

FieldDecl1:
	IdentifierList Type
	{
		$$ = []FieldDecl1{$1, $2} //TODO 122
	}
|	AnonymousField
	{
		$$ = $1 //TODO 123
...
FunctionDecl:
	...
	{
		$$ = []FunctionDecl{"func", $2, $3} //TODO 141
	}
...
IfStmt:
	...
	{
		$$ = []IfStmt{"if", $2, $3, $4} //TODO 151
	}
|	IF SimpleStmt ';' Expression Block2 IfStmt2
	{
		$$ = []IfStmt{"if", $2, ";", $4, $5, $6} //TODO 152
	}
...
|	'(' ImportDecl11 ')'
	{
		$$ = []ImportDecl1{"(", $2, ")"} //TODO 163
	}

ImportDecl11:
	/* EMPTY */
	{
		$$ = []ImportDecl11(nil) //TODO 164
	}
|	ImportDecl11 ImportSpec ';'
	{
		$$ = append($1.([]ImportDecl11), $2, ";") //TODO 165
	}
...
InterfaceType:
	...
	{
		$$ = []InterfaceType{"interface", "{", $3, "}"} //TODO 177
	}

InterfaceType1:
	/* EMPTY */
	{
		$$ = []InterfaceType1(nil) //TODO 178
	}
|	InterfaceType1 MethodSpec ';'
	{
		$$ = append($1.([]InterfaceType1), $2, ";") //TODO 179
	}
...
MapType:
	...
	{
		$$ = []MapType{"map", "[", $3, "]", $5} //TODO 200
	}

MethodDecl:
	FUNC Receiver MethodName MethodDecl1
	{
		$$ = []MethodDecl{"func", $2, $3, $4} //TODO 201
	}
...
PrimaryFactor:
	...
	{
		$$ = []PrimaryFactor{$1, $2} //TODO 237
	}

PrimaryFactor1:
	/* EMPTY */
	{
		$$ = []PrimaryFactor1(nil) //TODO 238
	}
|	PrimaryFactor1 PrimaryFactor11 PrimaryTerm
	{
		$$ = append($1.([]PrimaryFactor1), $2, $3) //TODO 239
	}
...
PrimaryTerm:
	...
	{
		$$ = []PrimaryTerm{$1, $2} //TODO 244
	}

PrimaryTerm1:
	/* EMPTY */
	{
		$$ = []PrimaryTerm1(nil) //TODO 245
	}
|	PrimaryTerm1 PrimaryTerm11 UnaryExpr
	{
		$$ = append($1.([]PrimaryTerm1), $2, $3) //TODO 246
	}
...
RangeClause:
	...
	{
		$$ = []RangeClause{$1, "range", $3} //TODO 254
	}
...
|	'(' DclName TYPE_NAME ')'
	{
		$$ = []Receiver{"(", $2, $3, ")"} //TODO 259
	}
|	'(' DclName '*' TYPE_NAME ')'
	{
		$$ = []Receiver{"(", $2, "*", $4, ")"} //TODO 260
	}
...
RecvStmt11:
	ExpressionList '='
	{
		$$ = []RecvStmt11{$1, "="} //TODO 268
	}
|	IdentifierList COLAS
	{
		$$ = []RecvStmt11{$1, $2} //TODO 269
	}
...
SelectStmt:
	SELECT '{' SelectStmt1 '}'
	{
		$$ = []SelectStmt{"select", "{", $3, "}"} //TODO 275
	}

SelectStmt1:
	/* EMPTY */
	{
		$$ = []SelectStmt1(nil) //TODO 276
	}
|	SelectStmt1 CommClause
	{
		$$ = append($1.([]SelectStmt1), $2) //TODO 277
	}
...
SendStmt:
	...
	{
		$$ = []SendStmt{$1, $2, $3} //TODO 279
	}

ShortVarDecl:
	IdentifierList COLAS ExpressionList
	{
		$$ = []ShortVarDecl{$1, $2, $3} //TODO 280
	}

Signature:
	Parameters Signature1
	{
		$$ = []Signature{$1, $2} //TODO 281
	}
...
SliceType:
	'[' ']' ElementType
	{
		$$ = []SliceType{"[", "]", $3} //TODO 299
	}

SourceFile:
	PackageClause ';' SourceFile1 SourceFile2
	{
		$$ = []SourceFile{$1, ";", $3, $4} //TODO 300
	}

SourceFile1:
	/* EMPTY */
	{
		$$ = []SourceFile1(nil) //TODO 301
	}
|	SourceFile1 ImportDecl ';'
	{
		$$ = append($1.([]SourceFile1), $2, ";") //TODO 302
	}

SourceFile2:
	/* EMPTY */
	{
		$$ = []SourceFile2(nil) //TODO 303
	}
|	SourceFile2 TopLevelDecl ';'
	{
		$$ = append($1.([]SourceFile2), $2, ";") //TODO 304
	}

Start:
	SourceFile
	{
		_parserResult = $1 //TODO 305
	}
...
StatementList2:
	/* EMPTY */
	{
		$$ = []StatementList2(nil) //TODO 324
	}
|	StatementList2 ';' StatementList21
	{
		$$ = append($1.([]StatementList2), ";", $3) //TODO 325
	}
...
StructType:
	STRUCT '{' StructType1 '}'
	{
		$$ = []StructType{"struct", "{", $3, "}"} //TODO 328
	}

StructType1:
	/* EMPTY */
	{
		$$ = []StructType1(nil) //TODO 329
	}
|	StructType1 FieldDecl ';'
	{
		$$ = append($1.([]StructType1), $2, ";") //TODO 330
	}
...
TypeAssertion:
	'.' '(' Type ')'
	{
		$$ = []TypeAssertion{".", "(", $3, ")"} //TODO 343
	}

TypeCaseClause:
	TypeSwitchCase ':' StatementList
	{
		$$ = []TypeCaseClause{$1, ":", $3} //TODO 344
	}

TypeDecl:
	TYPE TypeDecl1
	{
		$$ = []TypeDecl{"type", $2} //TODO 345
	}
...
|	'(' TypeDecl11 ')'
	{
		$$ = []TypeDecl1{"(", $2, ")"} //TODO 347
	}

TypeDecl11:
	/* EMPTY */
	{
		$$ = []TypeDecl11(nil) //TODO 348
	}
|	TypeDecl11 TypeSpec ';'
	{
		$$ = append($1.([]TypeDecl11), $2, ";") //TODO 349
	}
...
|	DclName COLAS
	{
		$$ = []TypeSwitchGuard1{$1, $2} //TODO 368
	}

TypeSwitchStmt:
	SWITCH TypeSwitchGuard LBR TypeSwitchStmt1 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, $3, $4, "}"} //TODO 369
	}
|	SWITCH SimpleStmt ';' TypeSwitchGuard LBR TypeSwitchStmt2 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, ";", $4, $5, $6, "}"} //TODO 370
	}

TypeSwitchStmt1:
	/* EMPTY */
	{
		$$ = []TypeSwitchStmt1(nil) //TODO 371
	}
|	TypeSwitchStmt1 TypeCaseClause
	{
		$$ = append($1.([]TypeSwitchStmt1), $2) //TODO 372
	}

TypeSwitchStmt2:
	/* EMPTY */
	{
		$$ = []TypeSwitchStmt2(nil) //TODO 373
	}
|	TypeSwitchStmt2 TypeCaseClause
	{
		$$ = append($1.([]TypeSwitchStmt2), $2) //TODO 374
	}
...
VarDecl11:
	/* EMPTY */
	{
		$$ = []VarDecl11(nil) //TODO 387
	}
|	VarDecl11 VarSpec ';'
	{
		$$ = append($1.([]VarDecl11), $2, ";") //TODO 388
	}

VarSpec:
	IdentifierList VarSpec1
	{
		$$ = []VarSpec{$1, $2} //TODO 389
	}

VarSpec1:
	Type VarSpec11
	{
		$$ = []VarSpec1{$1, $2} //TODO 390
	}
|	'=' ExpressionList
	{
		$$ = []VarSpec1{"=", $2} //TODO 391
