...
// at 2014-02-07 13:56:29.912368731 +0100 CET
//
...
SendStmt:
	Channel TOK13 /* "<-" */ Expression
	{
		$$ = []SendStmt{$1, "<-", $3} //TODO 271
	}

ShortVarDecl:
	IdentifierList TOK24 /* ":=" */ ExpressionList
	{
		$$ = []ShortVarDecl{$1, ":=", $3} //TODO 272
	}
...
|	IDENTIFIER TOK24 /* ":=" */ PrimaryExpr '.' '(' TYPE ')'
	{
		$$ = []TypeSwitchGuard{$1, ":=", $3, ".", "(", "type", ")"} //TODO 360
	}

TypeSwitchStmt:
	SWITCH TypeSwitchGuard '{' TypeSwitchStmt1 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, "{", $4, "}"} //TODO 361
	}
|	SWITCH SimpleStmt ';' TypeSwitchGuard '{' TypeSwitchStmt2 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, ";", $4, "{", $6, "}"} //TODO 362
	}
