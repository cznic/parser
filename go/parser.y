...
// at 2014-02-07 13:37:42.640564654 +0100 CET
//
...
SendStmt:
	Channel TOK7 /* "<-" */ Expression
	{
		$$ = []SendStmt{$1, "<-", $3} //TODO 278
	}

ShortVarDecl:
	IdentifierList TOK21 /* ":=" */ ExpressionList
	{
...
TypeSwitchStmt:
	...
	{
		$$ = []TypeSwitchStmt{"switch", $2, "{", $4, "}"} //TODO 369
	}
|	SWITCH SimpleStmt ';' TypeSwitchGuard '{' TypeSwitchStmt2 '}'
	{
		$$ = []TypeSwitchStmt{"switch", $2, ";", $4, "{", $6, "}"} //TODO 370
	}
...
|	VarSpec VarDecl111 VarDecl112
	{
		$$ = []VarDecl11{$1, $2, $3} //TODO 390
	}

VarDecl111:
	/* EMPTY */
	{
		$$ = []VarDecl111(nil) //TODO 391
	}
|	VarDecl111 ';' VarSpec
	{
		$$ = append($1.([]VarDecl111), ";", $3) //TODO 392
	}
...
VarSpec:
	...
	{
		$$ = []VarSpec{$1, $2} //TODO 395
	}

VarSpec1:
	Type VarSpec11
	{
		$$ = []VarSpec1{$1, $2} //TODO 396
	}
|	'=' ExpressionList
	{
		$$ = []VarSpec1{"=", $2} //TODO 397
